    ...
    new ol.layer.Group({
      ...
      layers: [
        ...
        new ol.layer.Tile({
          ...
          source: new ol.source.TileWMS({
            url:
              'http://gis.lesprojekt.cz/cgi-bin/mapserv?map=/home/dima/maps/ilida/ilida.map',
            params: {
        ...
        new ol.layer.Tile({
          ...
          source: new ol.source.TileWMS({
            url:
              'http://foodie-data.wirelessinfo.cz/geoserver-hsl/kojcice/wms?',
            params: {
...
module.controller('Main', [
  ...
  function ($scope, Core, layerAdderService, composition_parser, config) {
    ...
    layerAdderService.addService(
      'http://erra.ccss.cz/geoserver/ows',
      config.box_layers[1]
    );
  },
]);
